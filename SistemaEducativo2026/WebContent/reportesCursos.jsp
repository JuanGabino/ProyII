	...
	$.ajax({
        ...
        { 
        	...
        	for (var i=0;i<var1.length-1;i++) {
			    ...
			    $('#cursos').append(
			    	'<div class="col-md-4">'+
			    		'<form action="reportesNotas.jsp">'+
			    		'<input type="hidden" name="txtcurso" value="'+ curso + '">' +
			        	'<center><button type="submit" class="btn btn-success" style="width:320px; height:80px; font-size: 20px" id="btnCurso" name="txtIdCurso" value="'+ id + '"><strong>'+curso+'<strong></button></center>' +
			        	'</form>'+
			        '</div>'
