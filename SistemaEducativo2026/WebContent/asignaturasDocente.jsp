...
<head>
 ...
 <script type="text/javascript">
	$('#cursos').on('click', '#btnCurso', function(){
		 ...
		 window.location.href = "notasCurso.jsp";
   ...
   <div class="col-md-9" id="contenido">
    	<div class="panel panel-default" >
			...
			<div class="panel-heading">
	  			<h4><strong>LISTA DE CURSOS DICTADOS</strong></h4>
        ...
        { 
        	...
        	for (var i=0;i<var1.length-1;i++) {
			    ...
			    $('#cursos').append(
			        ...
			        '<center><button type="submit" class="btn btn-warning" style="width:450px; height:120px; font-size: 28px" id="btnCurso" name="txtIdCurso" value="'+ id + '">'+curso+'</button></center>' +
			        '</form>'+
			        '</div>' +'<br>'
